	...
	public class Adapter : AdapterBase
	{
		...
		public Adapter(CBCentralManager centralManager, IBleCentralManagerDelegate bleCentralManagerDelegate)
		{
			...
			_bleCentralManagerDelegate.DiscoveredPeripheral += (sender, e) =>
			{
				...
				var advertisingRecords = ParseAdvertisementData(e.AdvertisementData, out bool isConnectable);
		...
		private static Guid ParseDeviceGuid(CBPeripheral peripheral)
		{
			return Guid.ParseExact(peripheral.Identifier.AsString(), "d");
		}
		...
		public static List<AdvertisementRecord> ParseAdvertisementData(NSDictionary advertisementData, out bool isConnectable)
		{
