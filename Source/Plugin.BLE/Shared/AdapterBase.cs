...
namespace Plugin.BLE.Abstractions
{
	...
	public abstract class AdapterBase : IAdapter
	{
		...
		/// <summary>
		/// Occurs when a device has been disconnected. This occurs on unsolicited disconnects, such as when Bluetooth is disabled, the device goes out of range, powered off, or communication is lost otherwise.
		/// </summary>
		...
		protected void HandleDeviceBondStateChanged(DeviceBondStateChangedEventArgs args) => DeviceBondStateChanged?.Invoke(this, args);
