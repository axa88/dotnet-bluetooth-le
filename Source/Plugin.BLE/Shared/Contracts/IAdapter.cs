...
public interface IAdapter
{
	...
	IReadOnlyList<IDevice> GetConnectedOrBondedDevices(Guid[] services = null);
	...
	IReadOnlyList<IDevice> GetConnectedOrBondedDevicesByIds(Guid[] ids);

	#endregion ConnectedOrBonded
