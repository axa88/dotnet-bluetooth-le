...
public abstract class BleImplementationBase : IBluetoothLE
{
	...
	public BluetoothState State
	{
		...
		protected set
		{
			...
			var oldState = _state;
			_state = value;
			StateChanged?.Invoke(this, new(oldState, _state));
		}
	}
	...
	/// </summary>
	protected BleImplementationBase() => _adapter = new(CreateAdapter, System.Threading.LazyThreadSafetyMode.PublicationOnly);
	...
	private IAdapter CreateAdapter() => IsAvailable ? CreateNativeAdapter() : new FakeAdapter();
	...
	/// </summary>
	/// <param name="on"></param>
	/// <returns>true if the method executed with success otherwise false</returns>
